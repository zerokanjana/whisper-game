...
_subject    = ["ฉัน","คุณ","เขา","มัน","พวกเรา","พวกเขา","คน","ชาวบ้าน","you","she","they","he"]
ext_sub     = [None,"ที่สูงๆ","ที่กวาดถนนอยู่","ตรงนั้น","ในห้องนั้น","fat",]
_verb       = ["กำลังวิ่ง","เดิน","คุยกัน","นอนอยู่"]
ext_verb    = [None,"อย่างรวดเร็ว","ช้าๆ","เสียงดังมาก"]ั
